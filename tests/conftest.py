...
def vacancies_for_filter():
    return [Vacancy("Промоутер-консультант в школу программирования Sky Pro", "https://hh.ru/vacancy/116920119",
                    "40000 - 65000",
                    "Требования: Ты общительный и любишь людей. *Обладаешь грамотной речью и располагаешь к себе.."),
            Vacancy("QA инженер/Тестировщик", "https://hh.ru/vacancy/116907826", "200000",
                    "Требования: Стаж написания автоматических тестов от 1 года ..."),
            Vacancy("Junior Developer (стажер)", "https://hh.ru/vacancy/116792570", "70000",
                    "Требования: Базовые знания фронтенд-технологий: HTML, CSS, JavaScript. Обязанности: Участие в разработке программного обеспечения ")]


@pytest.fixture()
def sorted_vacancies():
    return ('Вакансия номер 1: Название: QA инженер/Тестировщик, Ссылка: https://hh.ru/vacancy/116907826, '
